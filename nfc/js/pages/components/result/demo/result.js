...
export default class result extends React.Component {
    render() {
        return (<ScrollView style={{ backgroundColor: '#F5F5F9', flex: 1 }}>
            ...
            <Result img={<Image source={require('./alipay.png')} style={{ width: 60, height: 60 }}/>} title="验证成功" message="所提交内容已成功完成验证" buttonText="完成" buttonType="primary" buttonClick={e => alert(e.toString())}/>
        </ScrollView>);
    }
}
