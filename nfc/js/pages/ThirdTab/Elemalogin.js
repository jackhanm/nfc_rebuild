...
const BG_IMAGE = require('../../imgResouce/bg_screen4.jpg');
...
export default class Elemalogin extends Component<{}> {
    constructor(props) {
        super(props);
                            ...
                            <KeyboardAvoidingView contentContainerStyle={styles.loginContainer} behavior='position'>
                                <View style={styles.titleContainer}>
                                    <View style={{flexDirection: 'row'}}>
                                        <Text style={styles.titleText}>征信查询</Text>
                                    </View>
                                    <View style={{marginTop: 10, marginLeft: 10}}>
                                        <Text style={styles.titleTextsmall}>长天金服</Text>
                                    </View>
                                </View>
                                <View style={{flexDirection: 'row'}}>
                                    <Button
