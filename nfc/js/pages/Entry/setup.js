    ...
    return StackNavigator(
        {
            ...
            TabBar: { screen: MyStackNavigation,navigationOptions:{header:null}},
            ...
            PersonalData:{screen:PersonalData,navigationOptions:{header:null}},
            WebViewCommunication :{screen:WebViewCommunication,navigationOptions:{header:null}},
            ChangePassWord:{screen:ChangePassWord,navigationOptions:{header:null}},
            AccountInfo:{screen:AccountInfo,navigationOptions:{header:null}},
            MineAbout:{screen:MineAbout,navigationOptions:{header:null}},
            NfcLogin:{screen:NfcLogin,navigationOptions:{header:null}},
            MineDownload:{screen:MineDownload,navigationOptions:{header:null}},
            MineRecored:{screen:MineRecored,navigationOptions:{header:null}},
            SearchList:{screen:SearchList,navigationOptions:{header:null}},
            homeMorelist:{screen:homeMorelist,navigationOptions:{header:null}},
