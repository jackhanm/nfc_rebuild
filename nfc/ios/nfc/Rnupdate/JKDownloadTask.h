...
typedef NS_ENUM(NSUInteger, JKDownloadStatus) {
  JKDownloadStatusWaiting,
  JKDownloadStatusDownloading,
  JKDownloadStatusPaused,
  JKDownloadStatusFinished,
  JKDownloadStatusFailed
};
#define IS_IOS10ORLATER ([[[UIDevice currentDevice] systemVersion] floatValue] >= 10)
/**某一任务下载的状态发生变化的通知*/
static NSString * const kDownloadStatusChangedNoti = @"kDownloadStatusChangedNoti";

#pragma mark - JKDownloadTaskDelegate
@class JKDownloadTask;
@protocol JKDownloadTaskDelegate <NSObject>
...
@property (nonatomic, weak) id <JKDownloadTaskDelegate>delegate;
...
#pragma mark - JKResumeData
@interface JKResumeData: NSObject
